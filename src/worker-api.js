...
const DASHBOARD_ASSET_BASE = 'https://cdn.jsdelivr.net/gh/masum065/google-drive-cdn-worker@main/src/assets';
const DEFAULT_ASSET_CONFIG = {
	cssUrl: `${DASHBOARD_ASSET_BASE}/main.css?v=${Date.now()}`,
	jsUrl: `${DASHBOARD_ASSET_BASE}/main.js?v=${Date.now()}`,
};
	...
	const openApiSpec = {
		...
		info: {
			...
			contact: {
				...
				url: 'https://github.com/masum065/google-drive-cdn-worker',
			},
		},
